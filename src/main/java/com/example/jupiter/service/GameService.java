...
public class GameService {
    private static final String TOKEN = "Bearer 673jrr19fnwank9h0yw2nynfwa6iea";
    private static final String CLIENT_ID = "en3cgbvci360n9ockdnhi4eq1jffh3";
    private static final String TOP_GAME_URL = "https://api.twitch.tv/helix/games/top?first=%s";
    private static final String GAME_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/games?name=%s";
    private static final int DEFAULT_GAME_LIMIT = 20;
    public static final String STREAM_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/streams?game_id=%s&first=%s";
    public static final String VIDEO_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/videos?game_id=%s&first=%s";
    public static final String CLIP_SEARCH_URL_TEMPLATE = "https://api.twitch.tv/helix/clips?game_id=%s&first=%s";
    ...
    protected List<Item> searchStreams(String gameId, int limit) throws TwitchException {
    ...
    protected List<Item> searchClips(String gameId, int limit) throws TwitchException {
    ...
    protected List<Item> searchVideos(String gameId, int limit) throws TwitchException {
